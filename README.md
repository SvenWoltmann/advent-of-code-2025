...
This project uses [Java 25 features](https://www.happycoders.eu/java/java-25-features/), including preview features, so many classes must be compiled and run with [Java 25](https://jdk.java.net/25/) and the `--enable-preview` flag.
